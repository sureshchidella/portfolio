...
// Stable particles (avoids hydration mismatch with Math.random)
    ...
    >
      ...
      >
        ...
        <motion.div variants={item} className="flex justify-center mb-7">
          <motion.div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-indigo-500/25 text-sm text-indigo-300"
        ...
        >
          <span className="text-xl sm:text-2xl text-slate-400 font-medium font-display">
            {displayText}
            <motion.span
        ...
        <motion.p
          variants={item}
          className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed mb-11"
        >
          Building production-grade microservices for{" "}
          <span className="text-white font-semibold">Mastercard</span> &{" "}
          <span className="text-white font-semibold">Axis Bank</span>
        ...
        >
          ...
          <motion.a
            ...
            className="group px-8 py-3.5 rounded-xl font-medium text-slate-300 border border-white/10 hover:border-indigo-500/40 hover:text-white hover:bg-indigo-500/5 transition-all duration-300"
            whileHover={{ scale: 1.04 }}
            whileTap={{ scale: 0.96 }}
            data-cursor-hover
          >
